...
contract BearedMintCore is Context, IERC20, Ownable {
    ...
    string private constant _name = "BearedMint";
    string private constant _symbol = "$BRDMNT";
    ...
    constructor(address _taxWallet, address _devWallet, address _marketingWallet, address _liquidityWallet) {
